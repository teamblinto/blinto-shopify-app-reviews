...
- **Developer:** PageFly (Hanoi, Vietnam)
- **Category:** Page Builders
- **Content type:** Single App Review
- **Human reviewer / assignee:** Imran
- **Due date:** TBD — add from ClickUp
- **ClickUp task:** TBD — add link
- **Shopify App Store:** https://apps.shopify.com/pagefly
- **GitHub repository:** https://github.com/teamblinto/blinto-shopify-app-reviews
- **Review Hub:** https://reviews.blinto.co
- **Content Preview:** TBD — set after first commit/deploy
- **Status:** Research & Write
- **Research date:** 2026-09-01
- **Last verified:** 2026-09-01 (public research only; see notes — direct App Store fetch was not accessible to the AI assistant, so figures below must be re-confirmed by the human reviewer in-browser)
...
- Shopify App Store: https://apps.shopify.com/pagefly
- Developer website: https://pagefly.io/
- Pricing: https://pagefly.io/pages/pricing ; https://help.pagefly.io/getting-started/pricing-and-billing/pricing-plans
- Documentation/help center: https://help.pagefly.io/
- Other official sources: PageFly blog (https://pagefly.io/blogs/shopify)
...
**Common positives:** Flexibility/customization of the drag-and-drop editor; large template library; live chat support responsiveness (per third-party review roundups).

**Common complaints / limitations:** Page load speed can degrade with heavy images, many third-party widgets, or complex sections (cited as the slowest of several compared page builders in one third-party benchmark); editor friction on complex layouts; some CRO features (e.g., A/B testing) gated to higher plans; learning curve for non-technical merchants.

**Sources reviewed:** Third-party roundup/review sites surfaced via web search (e.g., dodropshipping.com, thunderpagespeed.com, attnagency.com, minea.com) — summarized via search snippets, not directly fetched. Treat as **sourced third-party patterns**, not Blinto's own findings, until cross-checked against the human reviewer's own hands-on experience.
...
- ClickUp task link and due date for this review.
- Confirmation of current App Store rating, review count, and exact pricing plan names/prices/limits from the live listing.
- Full hands-on testing walkthrough (see chat — asked sequentially).
