...
Generated images must never contain: article titles, headlines, captions, paragraphs, fake UI text, fake buttons, fake dashboards, logos, or any random readable text. Typography is added separately by the website.
...
- [ ] Explicit "no text, no logos, no UI, no readable typography" instruction
